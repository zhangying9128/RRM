...
from train import build_input_from_segments, add_special_tokens_, pad_dataset, SPECIAL_TOKENS
...
class TransformerAgent(Agent):
    ...
    def __init__(self, opt, shared=None):
        ...
        print(torch.load(args.model_checkpoint+'model_training_args.bin'))
