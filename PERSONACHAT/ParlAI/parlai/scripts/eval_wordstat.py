...
def eval_wordstat(opt, print_parser=None):
    ...
    while not world.epoch_done():
        ...
        if batch_size == 1:
            ...
            if 'score_map' in world.acts[-1]:
                score_map = world.acts[-1]['score_map']
                word_statistics['score_map'].append(score_map)
            ...
            for w in world.worlds:
                try:
                    ...
                    if 'text' not in w.acts[0]:
                        word_statistics['context_list'].append('error')
                    else:
