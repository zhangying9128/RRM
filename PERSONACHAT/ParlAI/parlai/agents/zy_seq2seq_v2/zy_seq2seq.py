...
#zhangying
import sys
sys.path.append("/home/lr/zhang/ParlAI/parlai/agents/zy_seq2seq/")
from torch_generator_agent import TorchGeneratorAgent
...
class ZySeq2seqAgent(TorchGeneratorAgent):
