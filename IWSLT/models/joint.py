...
class JointAttentionModel(FairseqModel):
    ...
    def build_model(cls, args, task):
        ...
        decoder = JointAttentionDecoder(args, src_dict, tgt_dict, decoder_embed_tokens, left_pad=args.left_pad_target)
...
class JointAttentionDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, src_dict, dictionary, embed_tokens, left_pad=False, final_norm=True):
        super().__init__(dictionary)
        self.dropout = args.dropout
        ...
        self.generator_q =  nn.Parameter(torch.Tensor(len(src_dict), output_embed_dim))
